...
@section('content')
<div class="row">
    <div class="col-md-6 d-inline-block pl-5">
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col-md-8 d-inline table-keuangan ">

                <!-- Table Akun -->
                <table id="tes1" class="table table-bordered table-condensed table-sm">
                    <thead class="thead-light">
                        <th class="sorting" style="width: 60%;">Akun</th>
                        <th class="sorting" aria-controls="tes1" style="width: 40%;">Saldo</th>
                    </thead>
                    <tbody>
                        <tr>
                            <td>Kas</td>
