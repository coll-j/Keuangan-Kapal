                ...
                <nav class="pt-3">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link <?php if ($active == 'dashboard') {
                                                        echo ('active');
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if ($active == 'profil_perusahaan') {
                                                        echo ('active');
                                                    } ?>" href="{{ route('dashboard.profil_perusahaan') }}">
                                    Profil Perusahaan
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($active == 'page_data') {
                                                        echo ('active');
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if ($active == 'neraca') {
                                                        echo ('active');
                                                    } ?>" href="{{ route('dashboard.neraca') }}">
                                    Neraca
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link <?php if ($active == 'anggaran') {
                                                        echo ('active');
                                                    } ?>" href="{{ route('dashboard.anggaran') }}">
                                    Anggaran
                                </a>
                            </li>
                            <li class="nav-item">
