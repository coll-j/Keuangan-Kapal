...
Route::get('/delete_pemasok/{kode}', [App\Http\Controllers\AkunController::class, 'delPemasok']);
Route::get('/delete_proyek/{kode}', [App\Http\Controllers\AkunController::class, 'delProyek']);